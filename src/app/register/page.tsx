...
export default function RegisterPage() {
	...
	const testCases = [
		...
		{ label: "Invalid email (missing @)", email: "aliceexample.com", password: "S3cretPass!" },
		{ label: "Weak password", email: "bob@example.com", password: "abc" },
		{ label: "No domain", email: "carol@", password: "Password1" },
		{ label: "Common weak", email: "dave@example.com", password: "password" },
	];
	...
	function validateInputs(emailVal: string, passwordVal: string): string[] {
		...
		if (/password/i.test(passwordVal)) errs.push("Password is too common.");
		return errs;
	}
